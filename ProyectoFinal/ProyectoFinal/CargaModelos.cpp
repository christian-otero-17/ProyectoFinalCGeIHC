...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (avanzaH > 0)
		{
			...
			{
				movHelicoptero += movHeliOffset * deltaTime;
			}
			else
			{
				avanzaH = -1.0f;
		...
		if (avanzaf > 0)
		{
			if (movCoche < 5.0f)
			{
				spotLights[1] = SpotLight(0.0f, 1.0f, 0.0f,
					...
					1.0f, 0.0f, 0.0f,
					10.0f);
				spotLights[1].SetPos(glm::vec3(movCoche - 12.0, 0.0f, 0.0f));
			}
		}
		...
		else
		{
			if (movCoche > -5.0f)
			{
				spotLights[1] = SpotLight(0.0f, 0.0f, 1.0f,
					...
					1.0f, 0.0f, 0.0f,
					10.0f);
				spotLights[1].SetPos(glm::vec3(movCoche + 8.0f, 0.0f, 0.0f));
			}
		...
		//Llanta TD
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.7f, -0.1f, 0.2f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.07f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, rotllanta * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.0f, -0.1f, -1.25f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.07f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.7f, -0.1f, -1.25f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.07f));
		model = glm::rotate(model, 270 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, rotllanta * toRadians, glm::vec3(-1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		posblackhawk = glm::vec3(movHelicoptero, 5.0f*0.3*sin(movHelicoptero*10.0), 0.0f);
		model = glm::translate(model, posblackhawk);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(0.0f, 0.0f, avanzaH));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Material_brillante.UseMaterial(uniformSpecularIntensity, uniformShininess);
